...
def main(data_name, fold):
    ...
    inf = open(os.path.join(package_dir, 'output/' + FLAGS.model + '_' + FLAGS.dataset + '_' + str(FLAGS.embedding_size) + '_' + str(FLAGS.dropout) + '_' + str(FLAGS.learning_rate) + '_results.txt'), 'a+')
    ...
    for epoch in range(FLAGS.epochs):
        ...
        feed_dict = construct_feeddict_smodel(user_fea,item_fea,labels,label_weights,placeholders,sparse=False)
